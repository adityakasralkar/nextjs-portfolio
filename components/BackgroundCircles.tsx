...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    className="relative flex justify-center items-center">
        <div className="absolute border border-[#9c9c9c] rounded-full h-[200px] w-[200px] mt-52 animate-ping"/>
        ...
        <div className="absolute rounded-full border border-[#ffffff46] opacity-10 h-[650px] w-[650px] mt-52 animate-pulse" />
